    ...
    <b-row>
        ...
        <b-col md="12"
            ...
            <b-card header-tag="header"
                ...
                <b-card-body v-show="isHiddenStatusButton === true && (($can('update', 'Basepage') && $route.query.status !== 'trash') || ($can('delete', 'Basepage') && $route.query.status === 'trash'))">
                        ...
                        <b-form-group class="mb-0">
                            <b-dropdown id="dropdown-left"
                                ...
                                <template #button-content>
                                    ...
                                    <b-button v-show="$can('update', 'Basepage') && $can('delete', 'Basepage')"
                                              v-b-tooltip.hover
                                ...
                                <b-dropdown-item v-show="$can('update', 'Basepage') && $route.query.status === 'draft'"
                                                 href="javascript:;"
                                                 id="multi-publish"
                                                 variant="success"
                                ...
                                <b-dropdown-item v-show="$can('update', 'Basepage') && $route.query.status === 'publish'"
                                                 href="javascript:;"
                                                 id="multi-draft"
                                                 variant="warning"
                                                 @click="multiPostStatusChange">
                                ...
                                <b-dropdown-item v-show="$can('update', 'Basepage') && $route.query.status !== 'trash'"
                                                 href="javascript:;"
                                                 id="multi-trash"
                                                 variant="danger"
                                                 @click="multiPostStatusChange">
                                ...
                                <b-dropdown-item v-show="$can('delete', 'Basepage') && $route.query.status === 'trash'"
                                                 href="javascript:;"
                                                 id="multi-untrash"
                                                 variant="danger"
                                                 @click="multiPostStatusChange">
                ...
                <div v-else-if="isSpinnerShow == false && posts.length > 0">
                    <b-table :items="filteredData"
                        ...
                        <template #head(Id)="slot">
                            <b-form-checkbox :disabled="((!$can('update', 'Basepage') && $route.query.status !== 'trash') || (!$can('delete', 'Basepage') && $route.query.status === 'trash'))"
                        ...
                        <template #cell(Title)="row">
                            <b v-if="row.item.PostStatus == 2 || !$can('update', 'Basepage')">{{row.item.Title}}</b>
                            <b-link v-else
                                    :to="{ name:'pages-basepage-edit', query: { edit : row.item.Id } }">
                                <b>{{row.item.Title}}</b>
                            </b-link>
                            <div class="row-actions">
                                <div v-if="isHovered(row.item) && isHiddenRowActions">
                                    <b-link v-show="row.item.PostStatus != 0 && row.item.PostStatus != 2 && $can('update', 'Basepage')"
                                    ...
                                    <small v-show="row.item.PostStatus !== 2 && $can('update', 'Basepage')"
                                           class="text-muted"> | </small>
                                    <b-link v-show="row.item.PostStatus !== 2 && $can('update', 'Basepage')"
                                            :to="{ name:'pages-basepage-edit', query: { edit : row.item.Id } }"
                                    ...
                                    <small v-show="row.item.PostStatus === 2 && $can('update', 'Basepage') && $can('delete', 'Basepage')"
                                           class="text-muted"> | </small>
                                    <b-link v-show="row.item.PostStatus === 2 && $can('delete', 'Basepage')"
                                            href="javascript:;"
                                            no-prefetch
                                            class="text-danger small"
