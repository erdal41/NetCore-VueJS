    ...
    <b-row>
        ...
        <b-col md="12"
            ...
            <b-card id="basepage-list"
                ...
                <b-card-body v-if="isHiddenStatusButton === true && $can('update', 'Basepage')">
                        ...
                        <b-form-group class="mb-0">
                            <b-dropdown id="dropdown-left"
                                ...
                                <template #button-content>
                                    ...
                                    <b-button v-if="$can('update', 'Basepage') && $can('delete', 'Basepage')"
                                              v-b-tooltip.hover
                                ...
                                <b-dropdown-item v-if="$can('update', 'Basepage') && $route.query.status !== 'publish'"
                                                 href="javascript:;"
                                                 id="multi-publish"
                                                 variant="success"
                ...
                <b-table id="basepage-table"
                    ...
                    <template #head(Id)="slot">
                        <b-form-checkbox :disabled="!$can('update', 'Basepage') || filteredData.length <= 0"
                    ...
                    <template #cell(Id)="row">
                        <b-form-checkbox :disabled="!$can('update', 'Basepage')"
                    ...
                    <template #cell(Title)="row">
                        ...
                        <div class="row-actions">
                            <div v-if="isHovered(row.item) && isHiddenRowActions">
                                <b-link v-if="row.item.PostStatus != 0 && row.item.PostStatus != 2 && $can('update', 'Basepage')"
                                ...
                                <small v-if="row.item.PostStatus !== 2 && $can('update', 'Basepage')"
                                       class="text-muted"> | </small>
                                <b-link v-if="row.item.PostStatus !== 2 && $can('update', 'Basepage')"
                                        :to="{ name:'pages-basepage-edit', query: { edit : row.item.Id } }"
    ...
    export default {
        ...
        data() {
            return {
                ...
                isBusy: true,
                dataNullMessage: 'Hiçbir temel sayfa bulunamadı.',               
        ...
        methods: {
            ...
            postStatusChange: function (event, id, name) {
                axios.post('/admin/post-poststatuschange?postId=' + id + "&status=" + 1)
                    .then((response) => {
...
<style>
    #basepage-list.card .card-header {
        padding: 8px 8px 8px 8px !important;
    }

    #basepage-table.table th, #basepage-table.table td {
        padding: 0.72rem !important;
    }

    #basepage-table > tbody > tr.b-table-bottom-row td {
