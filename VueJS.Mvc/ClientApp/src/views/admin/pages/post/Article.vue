                    ...
                    <b-form>
                        <b-row>
                            <b-col cols="12">
                                ...
                                <b-form-group v-if="termType === 'category'"
                ...
                <div>
                    ...
                    <b-table :items="terms"
                        ...
                        <template #cell(Name)="row">
                                <b-link :to="{ name:'pages-term-edit', params: { term : row.item.Id } }">
                                    <b>{{row.item.Name}}</b>
                                </b-link>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                termType: this.$route.params.term_type,
                passValue: '',
                username: '',
                required,
                min,
        ...
        methods: {
                ...
                this.$refs.simpleRules.validate().then(success => {
                    if (success) {
                        axios.post('/admin/term/new',
                            ...
                            .then((response) => {
                                if (response.data.TermDto.ResultStatus === 0 && response.data.SeoObjectSettingDto.ResultStatus === 0) {
                                    this.$toast({
            ...
            getParentList() {
                axios.get('/admin/term/getparentlist', {
                    termId: null,
                    search: null
                })
                    .then((response) => {
